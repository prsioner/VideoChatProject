...
//音视频通话客户端
public class ClientLiveSocket {
    private static final String TAG = "ClientLiveSocket";
    private SocketCallBack socketCallback;
    MyWebSocketClient myWebSocketClient;
    public ClientLiveSocket(SocketCallBack socketCallback ) {
        this.socketCallback = socketCallback;
    }
    public void start() {
        try {
            URI url = new URI("ws://192.168.31.6:40001");
